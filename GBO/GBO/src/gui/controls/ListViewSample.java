...
public class ListViewSample extends Application
{
    public void start(Stage stage)
    {
        ...
        VBox box = new VBox();
        box.getChildren().addAll(list, l1, l2, bAdd, bSort, bRemove);
        ...
        list.getSelectionModel().getSelectedItems().addListener((ListChangeListener.Change<? extends Integer> change) ->
        {
        ...
        bAdd.setOnAction(e -> list.getItems().add((int) (Math.random() * 1000)));
        bSort.setOnAction(e -> FXCollections.sort(list.getItems()));
        bRemove.setOnAction(e -> list.getItems().removeAll(list.getSelectionModel().getSelectedItems()));
        stage.show();
    }
